...
interface Cache {
    function set(string $key, $val, int $expire);
    function get(string $key);
    function get_url(string $url): array;
    function clear_cached_url(string $url);
}

class DokCache implements Cache {
    ...
    public function clear_cached_url(string $url) {

    }

    public function get_url(string $url): array {
        $result = $this->get($url);
        if (!$result) {
