                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                { style: {
                                        flex: 1,
                                        transition: '.2s',
                                        background: this.props.mode === 'login' ? '#444466' : 'linear-gradient(white, gray)',
                            ...
                            React.createElement(
                                ...
                                { style: {
                                        flex: 1,
                                        transition: '.2s',
                                        background: this.props.mode === 'signup' ? '#444466' : 'linear-gradient(white, gray)',
...
class Login extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: 'button', onClick: this.login, style: {
                        position: 'absolute',
                        top: 0, right: 0,
                        margin: '0 8px',
                        width: 50, height: 50,
            ...
            React.createElement(LoginDialog, { mode: this.state.mode,
